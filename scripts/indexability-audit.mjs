...
const report = {
  generatedAt: new Date().toISOString(), policyVersion: 2, baselinePurpose: "Historical pre-policy-v2 snapshot in reports/indexability-before.json; not the baseline of the latest data expansion.",
  policy: {
